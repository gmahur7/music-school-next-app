        ...
        <div className='p-12 bg-grey-900'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6'>
                ...
                <div className='mt-10 text-center'>
                    <Link className='px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-grey-100 transition duration-200' href={'/webinars'}>View All Webinars</Link>
                </div>
            </div>
        </div>
    )
